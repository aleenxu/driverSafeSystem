(function() {
	$.extend({
		myAlert: function(options) {//参数格式{title:'Title',message:'message',callback:function(){alert('callback')}}or"需要提示的话"
			...
			$('body').append('<div class="pop-sys-box animated fadeIn"><div class="driver-bg opacity-div">pop bg</div>'
			+'</div>');
			$('.pop-sys-box').append('<div class="myModa animated slideInDown"><div class="myAlertBox"  style="margin-top:'+top+'px"><h6>'+option.title+'</h6><p>'+option.message+'</p><div class="btn sure">确定</div></div></div>');
